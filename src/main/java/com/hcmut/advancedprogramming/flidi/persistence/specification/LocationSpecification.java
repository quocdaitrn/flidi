...
public class LocationSpecification implements Specification<Location> {
    ...
    public LocationSpecification(final SpecSearchCriteria criteria) {
        super();
    ...
    @Override
    public Predicate toPredicate(final Root<Location> root, final CriteriaQuery<?> query, final CriteriaBuilder builder) {
